...
`cloud-itonami-isco-8114` is an OSS open-occupation blueprint. Governance covers
...
- Mineral Products Plant Coordination Governor remains independent of the advisor.
- hard policy violations cannot be overridden by human approval.
- a machine-operation-execution decision, a plant-safety-clearance
  decision, and any override of a plant safety officer's judgment,
  stay permanently outside this actor's op-allowlist.
- every commit, hold and approval path is auditable.
- real operator/plant/operator data stays outside Git.
...
- mishandling operator/plant/operator data
- misrepresenting certification status
- failing to respond to security incidents
- hiding material changes to customer-facing operation
- attempting to route a machine-operation-execution decision, a
